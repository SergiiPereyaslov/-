...
export function siteMetadata(l: Locale): Metadata {
  return {
...
/**
 * Спільна оболонка обох мовних дерев маршрутів.
 *
 * Українська версія живе в корені, російська — під /ru; обидві мають власний
 * root layout, який лише передає сюди свою локаль. Дерева маршрутів
 * продубльовані свідомо: єдиний сегмент [locale] вимагав би rewrite у
    ...
    <html lang={l} className={`${inter.variable} ${manrope.variable}`} suppressHydrationWarning>
      <body className="flex min-h-screen flex-col">
        {/*
          ...
          парсингу решти розмітки, тому спалаху світлої теми немає. У App Router
