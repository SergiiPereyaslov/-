...
const COPY = {
  uk: {
    ...
    why: [
      ...
      ['Макет — без доплати', 'Розробка дизайну або відмальовування вашого логотипу у вектор вже включені в ціну друку. Це не окрема послуга з окремим рахунком.'],
    ],
  ...
  ru: {
    ...
    why: [
      ...
      ['Макет — без доплаты', 'Разработка дизайна или отрисовка вашего логотипа в вектор уже включены в цену печати. Это не отдельная услуга с отдельным счётом.'],
    ],
...
export async function meta(l: Locale): Promise<Metadata> {
  return pageMeta({
    locale: l,
    path: '/brenduvannya/',
    title: l === 'uk' ? 'Брендування: друк логотипу' : 'Брендирование: печать логотипа',
    description:
      l === 'uk'
...
export default function BrandingPage({ locale: l }: { locale: Locale }) {
