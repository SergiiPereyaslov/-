        ...
        <div className="space-y-6">
          ...
          {items.length > 0 && (
            <div>
              ...
              {/*
                Суми рахує кошик у браузері й надсилає разом із заявкою, тому
                вони лише орієнтир: рахунок менеджер виставляє за прайсом.
              */}
              <p className="mt-2 text-xs text-muted">
                Суми — з кошика клієнта. Перед виставленням рахунку звірте з прайсом.
              </p>
            </div>
          )}
        </div>
