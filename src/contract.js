...
const PLACEHOLDERS = [
  ...
  ['ЗАМОВНИК', 'Повна назва замовника'],
  ['ЗАМОВНИК_КОРОТКО', 'Коротка назва замовника'],
  ['ЗАМОВНИК_КОД', 'Код замовника'],
  ['ЗАМОВНИК_ЄДРПОУ', 'ЄДРПОУ замовника (якщо заповнено)'],
  ['ЗАМОВНИК_АДРЕСА', 'Адреса замовника (якщо заповнено)'],
