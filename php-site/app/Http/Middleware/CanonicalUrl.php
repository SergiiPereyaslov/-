...
class CanonicalUrl
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        /*
         * Нормалізація стосується лише читання.
         *
         * Редирект на POST чи PUT губить тіло запиту: браузер за 301
         * повторює звернення методом GET і без даних форми. Зовні це
         * виглядає так, ніби форма збереглась, — сторінка перезавантажилась
         * без помилки, — але нічого не змінилось. Помилка мовчазна, і
         * знайти її можна лише тоді, коли хтось помітить, що ціна не та.
         */
