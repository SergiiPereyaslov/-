...
## Назва: LeadRadar / ЛідРадар `[CLIENT 2026-08-05]`

Продукт названо **LeadRadar** (укр. **ЛідРадар**). Дніпрограф — тенант №1 і
пілот; будуємо спочатку під нього, потім узагальнюємо.

Назва проходить перевірки, на яких спіткнувся «Дніпрокол»: немає прив'язки до
міста при географії на всю Україну, немає небажаного слова всередині,
однаково читається латиницею й кирилицею. Метафора — радар знаходить те, що
вже є в ефірі, — описує саме те, що робить сервіс: не створює попит, а
знаходить готових у наявній базі.

Що лишається перевірити перед публічним запуском (не блокує розробку):
вільність домену, торгова марка в класі 35/42, і скільки ще сервісів у світі
вже звуться LeadRadar — назва не рідкісна.
